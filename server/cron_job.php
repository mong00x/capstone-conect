...
$query_expired_project_requests = "SELECT student_project_requests.student_id, student_name, project_id, project_ranking, approve, state_changed_time FROM student_project_requests
...
closeDB();
while (mysqli_num_rows($result_expired_project_requests) > 0) {
